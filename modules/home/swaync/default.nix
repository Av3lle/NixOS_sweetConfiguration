    ...
    config = mkIf cfg.enable {
        services.swaync = {
          ...
          widgets = [
            ...
            "mpris"
            "volume"
            "menubar#desktop" # Питание и скришоты
            "menubar#desktop2" # Ночной свет и режим не беспокоить
          ];
          widget-config = {
            title = {
              text = "Quick settings";
