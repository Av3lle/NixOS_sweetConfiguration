        ...
        environment.systemPackages = with pkgs; [
            (pkgs.writeShellScriptBin "rebuild" ''
                ...
                git_commit_public() {
                    rsync -a --delete \
                        --exclude='.git' \
                        --exclude-from=~/.config/nixos/.gitignore \
                ...
                flake() {
                    ...
                    run_with_notify "Flake update" \
                        doas nix flake update --flake ${pathsConfig.flakeDir} 
                }
                ...
                ''
                    ...
                    nixos() {
                        ...
                        if doas nixos-rebuild switch --show-trace \
                            --flake ${pathsConfig.flakeDir}#${machine} --upgrade 2>&1 |& nom; then
                ...
                ''
                    ...
                    home_manager() {
                        ...
                        if home-manager switch --show-trace \
                            --flake ${pathsConfig.flakeDir}#${machine} 2>&1 |& nom; then
                            hm_now=$profiles
